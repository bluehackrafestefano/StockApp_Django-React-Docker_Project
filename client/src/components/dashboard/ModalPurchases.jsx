...
export default function ModalTransaction({open,handleClose,info,setInfo,initialValues}) {
    const {products,postPurchase,putPurchase,firms,brands} = useContext(StockContext)
    ...
    const handleSubmit = (e) =>{
        ...
        handleClose()
        if(info.id){
          putPurchase(info,navigate)
          setInfo(initialValues)       
        }else{
          postPurchase(info,navigate)
          setInfo(initialValues)       
        }
  ...
  return (
    <div>
      ...
      >
        ...
        <FormControl >
          <InputLabel variant="outlined" id="firm-select-label">Firm</InputLabel>
          <Select
